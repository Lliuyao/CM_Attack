...
TEXTATTACK_DATASET_BY_MODEL = {
    ...
    #
    "t5-en-de": (
        "textattack.dataset.helpers.TedMultiTranslationDataset",
        "en",
        "de",
    ),
    "t5-en-fr": (
...
class DatasetArgs:
    ...
    def _add_parser_args(cls, parser):
        ...
        dataset_group.add_argument(
            ...
            required=False,
            default=None,
            help="Dataset to load from `dataset` repository.",
        )
        dataset_group.add_argument(
            "--dataset-from-file",
            type=str,
    ...
    def _create_dataset_from_args(cls, args):
        ...
        if args.dataset_by_model in HUGGINGFACE_DATASET_BY_MODEL:
            ...
            if dataset[0].startswith("textattack"):
                ...
                # ex: dataset = ('textattack.dataset.helpers.TedMultiTranslationDataset', 'en', 'de')
        ...
        if args.dataset_from_file:
            ...
            if args.dataset_split:
                if len(dataset_args) > 1:
                    ...
                    dataset = textattack.dataset.HuggingFaceDataset(
        ...
        ), "Loaded `dataset` must be of type `textattack.dataset.Dataset`."
