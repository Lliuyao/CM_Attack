...
class _CommandLineTrainingArgs:
    ...
    This requires more arguments to create models and get dataset.
    Args:
        ...
        dataset (str): dataset for training; will be loaded from `dataset` library.
    ...
    def _add_parser_args(cls, parser):
        ...
        parser.add_argument(
            ...
            "`dataset` library. if dataset has a subset, separate with a colon. "
