...
import textattack
from testdata.dOpenHowNet import longest_common_subsequence
...
class AttackedText:
    ...
    def lcs_all_words_diff(self, other_attacked_text: AttackedText) -> Set[int]:
        w1 = self.words
        w2 = other_attacked_text.words
        return max(len(w1), len(w2)) - longest_common_subsequence(w1, w2)
